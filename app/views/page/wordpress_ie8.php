			...
			<div class="area">
				...
				<div class="box1">
						<div class="contantbox">
							<div class="box" style="background-image:url(app/img/ie8/wordpress/contant3_box.png);background-position:center;">
								<div class="hoverbox">
									<p>餐廳 | 旅遊 | 音樂 | 娛樂</p>
								</div>
							</div>
						...
						<div class="contantbox">
							<div class="box" style="background-image:url(app/img/ie8/wordpress/contant3_box2.png);background-position:center;">
								<div class="hoverbox">
									<p>運動 | 休閒 | 醫療 | 美容</p>
								</div>
							</div>
						...
						<div class="contantbox" >
							<div class="box" style="background-image:url(app/img/ie8/wordpress/contant3_box3.png);background-position:center;">
								<div class="hoverbox">
									<p>攝影 | 藝術 | 設計 | 時尚</p>
								</div>
							</div>
		...
		<div class="content6">
			<div class="area">
				<div class="leftbox">
					...
					<img src="app/img/ie8/wordpress/contant6_text5.png" class="line">
				</div>
		...
		<div class="content7">
			<div class="area">
				...
				<div class="box">
					...
					<div class="itemDiv" style=" background-image:url(app/img/ie8/wordpress/contant7_box2.png);">
				...
				<div class="box box2">
					...
					<div class="itemDiv" style=" background-image:url(app/img/ie8/wordpress/contant7_box1.png);">
