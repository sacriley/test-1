...
<div class="contentBox allWidth">
	<h3>新增活動</h3>
	<h4>請填寫欲新增之活動資訊</h4>
	<?php echo form_open('admin/activity/postactivity/post') ?>
	<div class="spanLine">
	    <div class="spanStage">
	...
	<div class="spanLine">
	    ...
	    <div class="spanStage">
            ...
            <div class="spanLineRight">
                <p class="gray">目前活動排序方式為???，若需變更活動排序方式，請於「活動設置」後台變更</p>
            </div>
		</div>
	</div>
	<div class="spanLine spanSubmit">
	    <div class="spanStage">
            ...
            <div class="spanLineRight">
                ...
                <input type="submit" class="submit" value="<?if(isset($note['noteid'])):?>儲存變更<?else:?>新增活動<?endif?>">
                <?if( empty($note['noteid']) === FALSE ):?><span class="submit gray" onClick="fanScript.check_href_action('確定要刪除這篇活動？', 'admin/note/delete_note/<?=$note['noteid']?>/<?=$this->security->get_csrf_hash()?>');">刪除活動</span><?endif?>
            </div>
        </div>
	</div>
	</form>
