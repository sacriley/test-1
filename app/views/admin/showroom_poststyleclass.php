...
<h2>展示藝廊 - <?if(isset($class['classid'])):?>編輯<?else:?>新增<?endif?>風格分類標籤</h2>
<div class="contentBox allWidth">
	<h3><?if(isset($class['classid'])):?>編輯<?else:?>新增<?endif?>分類標籤</h3>
	<h4>請填寫欲標籤資訊</h4>
	<?php echo form_open('admin/showroom/poststyleclass/post') ?>
	<div class="spanLine">
	    <div class="spanStage">
	...
	<div class="spanLine spanSubmit">
		...
		<div class="spanLineRight">
            ...
            <?if( empty($class['classid']) === FALSE ):?><span class="submit gray" onClick="fanScript.check_href_action('確定要刪除這個分類？', 'admin/showroom/delete_styleclass/<?=$class['classid']?>/<?=$this->security->get_csrf_hash()?>');">刪除分類</span><?endif?>
		</div>
	</div>
	</form>
</div>
